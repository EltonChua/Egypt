    ...
    <div className="landing">
      ...
      <section id="banner">
        ...
        <ul className="actions">
          <li>
            <a href="https://youtu.be/CskfvgEItPA?si=IHcEYjHKtdTHHNhF" className="button big special">
              Learn More
            </a>
          </li>
        </ul>
        ...
        <div className="inner">
          <article className="feature left">
            ...
            <div className="content">
              <h2>Who is Firaun?</h2>
              <p>
                Firaun was the title given to the kings of ancient Egypt, particularly during the New Kingdom period, but the term is often used broadly to refer to Egyptian rulers throughout history. The word "Firaun" is derived from the biblical Hebrew term "Par'oh," which in turn has roots in earlier Semitic languages.
              </p>
              <ul className="actions">
                <li>
                  <a href="https://www.rekhta.org/allusions/firaun-and-musa-pharaoh-and-moses#:~:text=Firaun%20(Pharaoh)%20is%20the%20term,would%20bring%20about%20Firaun's%20death." className="button alt">
                    More
                  </a>
                </li>
              </ul>
          ...
          <article className="feature right">
            ...
            <div className="content">
              ...
              <p>
                The Great Sphinx has the body of a lion and the head of a human, believed to represent Pharaoh Khafre. It is carved directly from the bedrock of the Giza Plateau and is one of the largest and oldest statues in the world.
              </p>
              <ul className="actions">
                <li>
                  <a href="https://www.britannica.com/topic/Great-Sphinx" className="button alt">
                    More
                  </a>
                </li>
              </ul>
      ...
      <section id="two" className="wrapper special">
        <div className="inner">
          ...
          <ul className="actions">
            <li>
              <a href="https://www.gokitetours.com/egypt-tourist-attractions-you-cant-miss-on-your-journey/" className="button big alt">
                Learn More
              </a>
            </li>
          </ul>
      ...
      <footer id="footer">
        <div className="inner">
          <ul className="icons">
            ...
            <li>
              <a href="https://www.youtube.com/" className="icon fa fa-youtube">
